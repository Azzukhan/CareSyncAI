...
async def upload_health_file(
    ...
    return HealthFileUploadResponse(
        ...
        export_date=health_file.export_date,
        export_locale=health_file.export_locale,
        source_date_start=health_file.source_date_start,
        source_date_end=health_file.source_date_end,
        source_tag_counts=health_file.source_tag_counts,
    ...
    return HealthFilesListResponse(
        items=[
            HealthFileUploadResponse(
                ...
                provider=f.provider,
                export_date=f.export_date,
                export_locale=f.export_locale,
                source_date_start=f.source_date_start,
                source_date_end=f.source_date_end,
                source_tag_counts=f.source_tag_counts,
    ...
    return HealthMetricsListResponse(
        items=[
            HealthMetricResponse(
                ...
                source_start_at=m.get("source_start_at"),
                source_end_at=m.get("source_end_at"),
                source_record_count=int(m.get("source_record_count", 1)),
